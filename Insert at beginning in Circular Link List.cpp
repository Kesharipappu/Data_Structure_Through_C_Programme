//Insert at beginning in Circular Link List
#include<stdio.h>
#include<stdlib.h>
...
main()
{
	...
	printf("\nAfter Insert at Beginning in Circular Link List. Elements are\n");
	display();
}
